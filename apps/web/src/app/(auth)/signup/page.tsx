    ...
    <div className="min-h-screen bg-[#080c0a] flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-sm w-full">
          ...
          <button onClick={handleGoogleSignup} className="w-full flex items-center justify-center gap-2.5 py-2.5 px-4 border border-gray-700 rounded-lg text-sm font-medium text-gray-300 bg-white/5 hover:bg-white/10 transition mb-6">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <input id="email" type="email" autoComplete="email" required value={email} onChange={(e) => setEmail(e.target.value)}
                className="w-full px-3.5 py-2.5 bg-white/5 border border-gray-800 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500/50 transition" placeholder="you@company.com" />
            </div>
            <div>
