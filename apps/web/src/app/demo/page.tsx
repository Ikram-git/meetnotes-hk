      ...
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">See Briva in Action</h1>
          ...
          {step === 0 ? (
            <div className="text-center py-20 bg-[#111916] rounded-2xl border border-emerald-900/30">
              ...
              <p className="text-sm text-gray-500 max-w-md mx-auto mb-8">
                We'll simulate a short team meeting and show you exactly how Briva processes it — from raw audio to structured notes.
              </p>
          ...
          {step === 3 && (
            <div className="text-center mt-12 animate-fade-in">
              <h2 className="text-2xl font-bold text-white mb-3">That's Briva.</h2>
